...
- [Exercise 2: Writing a Hardware Component](#exercise-2-writing-a-hardware-component)
  ...
  - [2.2: Setup the babybot_firmware.hpp header file](#22-setup-the-babybot-firmwarehpp-header-file)
  - [2.3: Implement babybot_interface.cpp source file](#23-implement-babybot-interfacecpp-source-file)
